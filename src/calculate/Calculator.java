...
public class Calculator {
    ...
    public void addition(int a, int b) {
        System.out.println("Addition of Numbers  " + a + " and " + b + " is : " + +(a + b));
        //System.out.println(result);
    }

    public void subtraction(int a, int b) {
        System.out.println("Subtraction of Numbers " + a + " and " + b + " is :  " + (a - b));
    }

    public void division(int a, int b) {
        System.out.println(" Division of Numbers " + a + " and " + b + " is : " + (a / b));
    }

    public void multiplication(int a, int b) {
        System.out.println("Mutiplication of Numbers " + a + " and " + b + " is : " + (a * b));
    }
